...
worddict={1:['LASER','STEER','SAILS','SHEET','HOSES'],2:['HOSES','LASER','STEER','SHEET','SAILS'],3:['STEER','LASER','SAILS','SHEET','HOSES'],4:['HEEL','HIKE','KNOT','KEEL','LINE'],5:['HEEL','HIKE','KNOT','KEEL','LINE'],6:['AFT','EEL','ALE','LEE','TIE'],7:['AFT','EEL','ALE','LEE','TIE'],8:['HOSES','STEER','SAILS','SHEET','LASER']}
